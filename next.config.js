    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'none' ; script-src 'self' https://www.gstatic.com/recaptcha/ https://www.google.com/recaptcha/ https://*.vercel.app/ https://*.oshyn.com/ https://www.youtube.com/ https://www.youtube.com/iframe_api https://static.doubleclick.net; style-src 'self' 'unsafe-inline' https://*.vercel.app/ https://*.oshyn.com/ https://fonts.googleapis.com https://cdnjs.cloudflare.com https://www.youtube.com; object-src 'none'; base-uri 'self'; connect-src 'self' https://www.google.com/recaptcha https://*.vercel.app/ https://*.oshyn.com/; font-src 'self' https://fonts.gstatic.com/ https://cdnjs.cloudflare.com https://*.vercel.app; frame-src 'self' https://www.google.com/ https://www.youtube-nocookie.com/; img-src 'self' https://i.ytimg.com/ https://sc-dev-baaqmd.oshyn.com https://sc-dev-strategicplan.baaqmd.gov/ https://sc-dev-strategicplan.baaqmd.gov/~/media/ https://sc-qa.baaqmd.gov https://sc-qa.baaqmd.gov/~/media/ https://*.vercel.app/ https://*.oshyn.com/ https://www.youtube.com; manifest-src 'self'; worker-src 'none'; frame-ancestors 'self'; form-action 'self';",
          },
        ],
      },
    ];
